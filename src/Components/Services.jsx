    ...
    return (
        <section className="container service" id="service-me">
            ...
            <section className="row ">
                <article className="col-md-6 service-col">
                    <div className="card service-card" id="service-1">
                        <div className="card-body service-body">
                            ...
                            <div className="service-fondo">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-user-scan"
                ...
                <article className="col-md-6 service-col">
                    <div className="card service-card" id="service-2">
                        <div className="card-body service-body">
                            ...
                            <div className="service-fondo">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-diamond-filled"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                                    <path
                ...
                <article className="col-md-6 service-col">
                    <div className="card service-card" id="service-3">
                        <div className="card-body service-body">
                            ...
                            <div className="service-fondo">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-brand-codepen"
                                    width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"
                                    fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
